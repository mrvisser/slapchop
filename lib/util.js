...
/**
 * Invoke the provided function with the given methods only if "necessary" is true. If not, the callback will be
 * invoked with no params.
 */
var invokeIfNecessary = module.exports.invokeIfNecessary = function(/* necessary, function, args..., callback */) {
    var args = Array.prototype.slice.call(arguments);

    // If the first argument is falsey, we call the last argument (callback) as a function
    if (!args.shift()) {
        return _.last(arguments)();
    }

    // Shift the function off to call it, invoking it with the remainder of the arguments, including the callback
